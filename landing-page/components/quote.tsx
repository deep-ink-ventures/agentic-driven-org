  ...
  return (
    <section ref={ref} className="py-24 md:py-40 px-6 md:px-12">
      ...
      >
        ...
        <blockquote className="font-display text-2xl md:text-4xl font-medium text-silver-light leading-[1.3] tracking-[-0.01em]">
          Placeholder for client testimonial. Replace this with a real quote
          when ready.
        </blockquote>
        ...
        <div className="mt-10 flex items-center gap-4">
          ...
          <div>
            <p className="text-white font-medium text-sm">Name Surname</p>
            <p className="text-silver text-sm">Title, Company</p>
          </div>
        </div>
      </div>
    </section>
