...
from agents.blueprints.social_media.workforce.twitter.commands import engage_tweets, post_content, search_trends
...
class TwitterBlueprint(WorkforceBlueprint):
    ...
    tags = ["social-media", "twitter", "engagement", "content-creation"]
